                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                            <a class="nav-link " href="manage_cate" ><i class="fa fa-table"></i>Manage Category</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                        <li>
                                <a class="nav-link" href="add_prod" ><i class="fa fa-edit"></i>Add product</a>
                            </li>
                            <li>
                            <a class="nav-link" href="manage_prod" ><i class="fa fa-table"></i>Manage product</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                        <li>
                                <a class="nav-link" href="manage_cust" ><i class="fa fa-edit"></i>manage customer</a>
                            </li>

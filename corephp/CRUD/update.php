<?php require_once("connection.php"); $id=$_GET['id']; ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
$result=mysqli_query($conn,"UPDATE items SET image='$image_file',title='$title' WHERE id=$id"); 
	}
	else 
	{
	$result=mysqli_query($conn,"UPDATE items SET title='$title' WHERE id=$id"); 	
	} 
if($result)
{

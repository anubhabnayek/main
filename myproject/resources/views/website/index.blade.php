...
@php -->
            <section class="slick-slideshow">   
                <div class="slick-custom">
                    <img src="{{url('website/images/slideshow/medium-shot-business-women-high-five.jpeg')}}" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="{{url('website/images/slideshow/team-meeting-renewable-energy-project.jpeg')}}" class="img-fluid" alt="">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <a href="product" class="btn custom-btn">Explore products</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slick-custom">
                    <img src="{{url('website/images/slideshow/two-business-partners-working-together-office-computer.jpeg')}}" class="img-fluid" alt="">
                        ...
                        <div class="col-lg-10 col-12">
                            <div class="tab-content mt-2" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="{{url('website/images/pim-chu-z6NZ76_UTDI-unsplash.jpeg')}}" class="img-fluid" alt="">
                                        </div>
                                ...
                                <div class="tab-pane fade" id="pills-skill" role="tabpanel" aria-labelledby="pills-skill-tab">
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="{{url('images/cody-lannom-G95AReIh_Ko-unsplash.jpeg')}}" class="img-fluid" alt="">
                                        </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="{{url('images/retail-shop-owner-mask-social-distancing-shopping.jpg')}}" class="img-fluid" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail">
                                    <img src="{{url('website/images/product/evan-mcdougall-qnh1odlqOmk-unsplash.jpeg')}}" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail">
                                    <img src="{{url('website/images/product/jordan-nix-CkCUvwMXAac-unsplash.jpeg')}}" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                <a href="product-detail">
                                    <img src="{{url('website/images/product/nature-zen-3Dn1BZZv3m8-unsplash.jpeg')}}" class="img-fluid product-image" alt="">
                                </a>

...
@include('sweetalert::alert')
            <header class="site-header section-padding-img site-header-image">
                ...
                <img src="{{url('website/images/header/positive-european-woman-has-break-after-work.jpg')}}" class="header-image img-fluid" alt="">
            </header>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <form class="contact-form me-lg-5 pe-lg-3" action="{{url('/contact')}}" method="post">
                                @csrf
                                ...
                                <div class="form-floating my-4">
                                    <input type="email" name="email"  pattern="[^ @]*@[^ @]*" class="form-control" placeholder="Email address">
                                    @error('email')
                                    <p class="text-danger">{{ $message }}</p>
                                           @enderror
